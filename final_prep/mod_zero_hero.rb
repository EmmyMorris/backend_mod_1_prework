...
hero_name = "Spiderman"
special_ability = "Shoot spider webs"
# Declare two variables - greeting AND catchphrase
#   greeting should be assigned to a string that uses interpolation to include the hero_name
greeting = "Hi! I'm #{hero_name}!"
#   catchphrase should be assigned to a string that uses interpolation to include the special_ability
catchphrase = "I love to #{special_ability}!"
...
arch_enemies = ["Venom", "The Lizzard", "Carnage"]
#   sidekicks should be an array of at least 3 different sidekick strings
sidekicks = ["Andy Maguire", "Ezekiel Sims", "Silk"]
# Print the first sidekick to your terminal
p sidekicks[0]
# Print the last arch_enemy to the terminal
p arch_enemies[2]
# Write some code to add a new arch_enemy to the arch_enemies array
arch_enemies.append("Mysterio")
# Print the arch_enemies array to terminal to ensure you added a new arch_enemey
p arch_enemies
# Remove the first sidekick from the sidekicks array
sidekicks.delete("Andy Maguire")
...
scary_monster = {name: "Spider Guy", smell: "pungent", weight: 120 , cities_destroyed: ["Denver", "Castle Rock", "Parker", "Littleton"], lucky_numbers: [7, 10, 13, 20, 55], address: {number: 12345 , street: "Main" , state: "Colorado", zip: 34567}}
